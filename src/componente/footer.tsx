      ...
      <div className="max-w-7xl mx-auto px-6 pt-24 pb-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 lg:gap-20">
          ...
          <div className="col-span-1 md:col-span-1 group">
            <div className="mb-8">
              <h3 className="text-4xl md:text-5xl font-display font-bold tracking-tighter mb-6 group-hover:text-[#8FAE7A] transition-colors">
                MAISON <br />
          ...
          <div className="group">
            ...
            <div className="flex gap-4 mb-8">
              <a href="https://www.instagram.com/maison.organic?igsh=MWl4azRxbjFqdTJrZQ==" className="group relative w-12 h-12 rounded-full border-2 border-[#F4F2EC]/30 flex items-center justify-center hover:border-[#8FAE7A] hover:bg-[#8FAE7A] transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-[#8FAE7A]/25">
                <div className="absolute inset-0 bg-[#8FAE7A] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                <svg className="w-5 h-5 text-[#F4F2EC] relative z-10" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="group relative w-12 h-12 rounded-full border-2 border-[#F4F2EC]/30 flex items-center justify-center hover:border-[#8FAE7A] hover:bg-[#8FAE7A] transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-[#8FAE7A]/25">
                <div className="absolute inset-0 bg-[#8FAE7A] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                <svg className="w-5 h-5 text-[#F4F2EC] relative z-10" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              ...
              <div className="flex gap-2">
                ...
                />
                <button className="bg-[#8FAE7A] hover:bg-[#7A9B6A] text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">
                  →
                </button>
              </div>
            </div>
